\section{Experience}
    \cventry{April 2014 -- Present}{Erlang Developer}{eZuce}{Bucharest}{}{Developer of a call center solution.\newline{}
    \textbf{Main Achievments:}
    \begin{itemize}
        \item Developed a statistics module using Redis as backend.
        \item Backup and migration scripts between different versions. (Erlang, Python)
        \item Moved storage of certain types of files from disk to MongoDB GridFS.
        \item Fixed various bugs.
        \item Solved various support issues.
        \item Custom ivr lua scripts.
        \item Load testing the call center solution. (nodejs inhouse solution)
        \item Implemented a monitoring solution based on collectd, influxdb and grafana for monitoring the System Under Test.
    \end{itemize}
    \textbf{Attributions:}
    \begin{itemize}
        \item Since August the main developer for the Call Center solution.
        \item Plan and develop new features. Fix bugs.
    \end{itemize}
    \textbf{Experience with:}
    \begin{itemize}
        \item Programming languages: Erlang, Python, Lua, Javascript (nodejs).
        \item Products: Freeswitch, MongoDB, Redis, sipX stack.
    \end{itemize}
    }
	\cventry{March 2010 -- March 2014}{SQA Voip Engineer}{4PSA}{Bucharest}{}{All range of testing from unit to functional to performance.\newline{}%
